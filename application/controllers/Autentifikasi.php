...
class Autentifikasi extends CI_Controller
{
    ...
    {
        //jika statusnya sudah login, maka tidak bisa mengakses halaman login alias kembali ke tampilan user
...
'required|trim', ['required' => 'Password Harus diisi']);
        if ($this->form_validation->run() == false) {
            $data['judul'] = 'Login';
            $data['user'] = '';
            //kata 'login' merupakan nilai dari variabel judul dalam array $data akan dikirimkan ke view aute_header
